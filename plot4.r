...
#########################################################################################
# Create plot 4, 4 time series graphs, and output to PNG file
#########################################################################################
png(paste(path,"plot4.png",sep="\\"), width=480, height=480)
par(mfrow=c(2,2))
# plot (1,1)
plot(x=dataSample$DateTime, y=dataSample$Global_active_power, type="l", xlab=NA,ylab="Global Active Power")
# plot (1,2)
plot(x=dataSample$DateTime, y=dataSample$Voltage, type="l", xlab="datetime",ylab="Voltage")
# plot (2,1)
plot(x=dataSample$DateTime, y=dataSample$Sub_metering_1, type="l", col="black", xlab=NA,ylab="Energy sub metering")
lines(x=dataSample$DateTime, y=dataSample$Sub_metering_2, type="l", col="red")
lines(x=dataSample$DateTime, y=dataSample$Sub_metering_3, type="l", col="blue")
legend("topright", legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), col=c("black","red","blue"), lty=1, bty="n")
# plot (2,2)
plot(x=dataSample$DateTime, y=dataSample$Global_reactive_power, type="l", xlab="datetime",ylab="Global_reactive_power")
dev.off()
