...
#########################################################################################
# Create plot 1 histogram and output to PNG file
#########################################################################################
png(paste(path,"plot1.png",sep="\\"), width=480, height=480)
bloodOrangeColour = rgb((255/255), (37/255), 0)
hist(dataSample$Global_active_power, main="Global Active Power", xlab = "Global Active Power (kilowatts)", col=bloodOrangeColour)
dev.off()
